...
namespace EditorFguiAssets
{
    ...
    /// 查找空的文件夹
    /// </summary>
    public class FguiFindEmpyFolderEditorWindow : EditorWindow
    {

        public static FguiFindEmpyFolderEditorWindow window;
        public static void Open()
        {
            if (window == null)
            {
                window = EditorWindow.GetWindow<FguiFindEmpyFolderEditorWindow>("查找空的文件夹");
        ...
        private void Find()
        {
            string root = Setting.Options.fairyProject + "/assets";
            root = root.Replace("\\", "/");
