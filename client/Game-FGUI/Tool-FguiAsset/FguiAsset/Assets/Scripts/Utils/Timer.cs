...
public class Timer
{
	...
	public static Timer Register(float duration, Action onComplete, Action<Timer> onUpdate = null,
        bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
    {
        ...
        if (Timer._manager == null)
        {
            ...
            else
            {
                ...
                GameObject.DontDestroyOnLoad(managerObject);  //切换场景的时候不销毁
            }
        }
	...
	private readonly Action<Timer> _onUpdate;
	...
	private Timer(float duration, Action onComplete, Action<Timer> onUpdate,
